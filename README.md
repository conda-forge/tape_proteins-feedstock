...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tape_proteins-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15447&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tape_proteins-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tape_proteins` can be installed with:

```
conda install tape_proteins
```

It is possible to list all of the versions of `tape_proteins` available on your platform with:
